...
export class AccessControlController {
  ...
  removeUserPermissionOverride(
    ...
    return this.accessControlService.removeUserPermissionOverride(userId, permissionCode);
  }
  ...
  assignPermissionsToRole(
    ...
    return this.accessControlService.assignPermissionsToRole(roleId, body.permissionCodes ?? []);
  }
}
