...
- `remove-avatar.usecase.ts`: elimina la referencia del avatar y limpia el archivo local cuando aplica.
- `remove-avatar.usecase.spec.ts`: pruebas unitarias de eliminacion de avatar y cleanup de archivo.
