...
export const ABONADO_WORKFLOW_SEEDS: WorkflowSeed[] = [
  {
    ...
    states: [
      ...
      { clientId: ENVIO_CREATED, saleOrderStateId: 'ae9b51d9-9324-4d15-a648-626a5eabda3d', position: 2, positionX: -562.7316284179688, positionY: -309.2750778198242, isInitial: true, isFinal: false, isActive: true },
  ...
  },
  {
    ...
    states: [
      ...
      { clientId: CE_CREATED, saleOrderStateId: 'ae9b51d9-9324-4d15-a648-626a5eabda3d', position: 2, positionX: -562.7316284179688, positionY: -309.2750778198242, isInitial: true, isFinal: false, isActive: true },
