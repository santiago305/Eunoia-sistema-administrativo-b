...
import { UserManageableRole } from 'src/modules/users/adapters/out/persistence/typeorm/entities/user-manageable-role.entity';
...
@Module({
  imports: [AccessControlModule, TypeOrmModule.forFeature([Role, User, UserManageableRole])],
