...
export interface DocumentSeriesRepository {
  ...
  findById(serieId: string, tx?: TransactionContext): Promise<DocumentSerie | null>;
  creatDocumentSerie(documentSerie: DocumentSerie, tx?: TransactionContext): Promise<DocumentSerie>;
