...
@Module({
  imports: [PurchasesModule, SuppliersModule, CompaniesModule, InventoryModule, CatalogModule],
  ...
  exports: [GenerateInvoicePdfUseCase, GeneratePurchaseOrderPdfUseCase, PDF_RENDERER],
})
