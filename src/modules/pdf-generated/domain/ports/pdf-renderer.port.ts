...
import { SaleOrderPdfData } from "../interfaces/sale-order-data";
...
export { SaleOrderPdfData } from "../interfaces/sale-order-data";
...
export interface PdfRendererPort {
  ...
  renderSaleOrder(data: SaleOrderPdfData): Promise<Buffer>;
}
