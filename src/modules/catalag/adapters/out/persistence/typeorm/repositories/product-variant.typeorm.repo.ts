...
export class ProductVariantTypeormRepository implements ProductVariantRepository {
  ...
  async create(variant: ProductVar, tx?: TransactionContext): Promise<ProductVar> {
  ...
  async findById(id: string, tx?: TransactionContext): Promise<ProductVar | null> {
    const repo = this.getRepo(tx);
  ...
  async findBySku(sku: string, tx?: TransactionContext): Promise<ProductVar | null> {
    const repo = this.getRepo(tx);
  ...
  async findByBarcode(barcode: string, tx?: TransactionContext): Promise<ProductVar | null> {
    const repo = this.getRepo(tx);
  ...
  async listByProductId(productId: ProductId, tx?: TransactionContext): Promise<ProductVar[]> {
    const repo = this.getRepo(tx);
  ...
  async listActiveByProductId(productId: ProductId, tx?: TransactionContext): Promise<ProductVar[]> {
    const repo = this.getRepo(tx);
