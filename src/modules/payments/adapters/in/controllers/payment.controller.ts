...
export class PaymentsController {
  ...
  async approvePayment(
    ...
    return this.approvePaymentUsecase.execute({ paymentId: id, userId: user.id });
  }
  ...
  async rejectPayment(
    ...
    return this.rejectPaymentUsecase.execute({
      paymentId: id,
      userId: user.id,
      reason: body?.reason,
    });
  ...
  list(@Query() query: HttpListPaymentsQueryDto) {
    return this.listPayments.execute(PaymentsHttpMapper.toListPaymentsInput({
      ...
      companyPaymentAccountId: query.companyPaymentAccountId,
      companyPaymentAccountIds: query.companyPaymentAccountIds,
      fromDocumentType: query.fromDocumentType,
