...
@Module({
  imports: [
    TypeOrmModule.forFeature([ProductEntity, ProductVariantEntity, UnitEntity]),
  ],
  controllers: [ProductsController, ProductVariantsController, UnitsController],
  providers: [
    // use cases
    CreateProduct,
    UpdateProduct,
  ...
  exports: [PRODUCT_REPOSITORY, PRODUCT_VARIANT_REPOSITORY, UNIT_REPOSITORY],
})
