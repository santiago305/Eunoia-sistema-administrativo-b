...
export class PurchaseOrderTypeormRepository implements PurchaseOrderRepository {
  ...
  async update(
    ...
    if (params.paymentStatus !== undefined) patch.paymentStatus = params.paymentStatus;
    if (params.isRecurringSource !== undefined) patch.isRecurringSource = params.isRecurringSource;
    if (params.recurringTemplateId !== undefined) patch.recurringTemplateId = params.recurringTemplateId;
    if (params.requiresReceipt !== undefined) patch.requiresReceipt = params.requiresReceipt;
