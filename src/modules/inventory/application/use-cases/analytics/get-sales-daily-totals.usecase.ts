...
import { SalesDailyTotal } from '../../dto/analytics/output/sales-daily-total';

@Injectable()
export class GetSalesDailyTotalsUseCase {
  constructor(
  ...
  async execute(input: GetSalesTotalsInput): Promise<SalesDailyTotal[]> {
    ...
    return this.ledgerRepo.getSalesDailyTotals({
      ...input,
      stockItemId,
    });
  }
