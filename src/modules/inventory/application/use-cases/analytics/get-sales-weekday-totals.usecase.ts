...
import { SalesWeekdayTotal } from '../../dto/analytics/output/sales-weekday-total';

@Injectable()
export class GetSalesWeekdayTotalsUseCase {
  constructor(
  ...
  async execute(input: GetSalesTotalsInput): Promise<SalesWeekdayTotal[]> {
    ...
    return this.ledgerRepo.getSalesWeekdayTotals({
      ...input,
      stockItemId,
    });
  }
